...
public class FileService {
	 ...
	 * @return
	 */
	public PopupFileDTO uploadPopupFile(MultipartFile multipartFile, HttpSession httpSession){
		PopupFileDTO fileInfo = new PopupFileDTO();
		...
		if(multipartFile != null 
			...
			// 파일 확장자
			fileInfo.setExt(FilenameUtils.getExtension(orgFileName));
